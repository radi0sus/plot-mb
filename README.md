...
- `-e` , optional: export the line spectrum or spectra in a csv-like fashion; filename of the export is atom or compound label + ".dat" for each atom or compound and "all.dat" for the whole spectrum
